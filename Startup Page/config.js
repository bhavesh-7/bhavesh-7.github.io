window.CONFIG = {
  macros: [
    ...
    key: 'KeyP',
    icon: 'PEH',
    url: 'https://academy.tcm-sec.com/courses/enrolled/1152300',
    normalisedURL: 'academy.tcm-sec.com',
    commands: {
      go: {
        template: 'https://academy.tcm-sec.com/p/{$}',
    ...
    normalisedURL: 'udemy.com',
    commands: {
      go: {
        template: 'https://www.udemy.com/{$}',
        description: 'go to udemy'
      },
      search: {
        template: '{@}/results?search_query={$}'
      }
